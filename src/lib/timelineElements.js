const timelineElements = [
  {
    ...
    position: "Information and Computer Systems",
    location: "Victoria, BC",
    description: `During my time at Camosun College, I pursued a comprehensive program in Information and Computer Systems, which was composed of a one-year full-time certificate followed by a one-year diploma. The program was designed to provide students with a strong foundation in computer science, software development, and systems analysis. The curriculum was both technical and rigorous, requiring students to commit 25-30 hours per week in the classroom and an additional five hours daily for homework, including weekends.

    In the first year of the program, I developed a robust understanding of operating systems, web development, software engineering, and several programming languages. Courses included hands-on projects that required me to apply theoretical knowledge to real-world scenarios, fostering a deep understanding of how different technologies interact. I gained proficiency in languages such as Java, C#, and JavaScript, and learned the fundamentals of web technologies like HTML and CSS. This foundation allowed me to create dynamic and responsive web applications, setting the stage for my future work as a full stack developer.

    The second year of the program focused on more advanced topics, including system analysis and design, applied software development, and implementing security in various situations. I learned how to analyze complex systems, design efficient solutions, and ensure the security and integrity of software applications. The program also emphasized teamwork and collaboration, as we worked in groups to complete projects that simulated real-world development environments.

    Additionally, Camosun College offered an optional Co-op/Internship program, allowing students to supplement their classroom learning with up to three paid work terms. Although I was fully immersed in my studies, this option provided valuable real-world experience for many students, helping them transition smoothly into the workforce upon graduation. The combination of rigorous academics and practical experience prepared me to tackle the challenges of the tech industry with confidence and competence.`,
    buttonText: "Details",
    startDate: "2008",
    endDate: "2017",
    icon: "school",
    color: "blue",
    tech: ["Java", "JavaScript", "C#", "SQL", "HTML", "CSS"],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    location: "Victoria, BC",
    description: `After years of working with various organizations, I transitioned to freelancing, a move that allowed me to take full control of my career and focus on the projects that I am most passionate about. As a Freelance Developer, I have had the opportunity to work on a diverse range of projects, each with its own unique challenges and rewards.

    My freelancing work has primarily focused on building accessible, user-friendly web applications using modern technologies. I have leveraged my extensive experience in front-end and back-end development to deliver high-quality solutions that meet the specific needs of my clients. Technologies I frequently use include JavaScript, React, Next.js, AWS, and Firebase, as well as HTML, CSS, and Tailwind CSS for front-end design.
    ...
    Freelancing has been an incredibly fulfilling journey, allowing me to grow as a developer while making a meaningful impact through my work. I look forward to continuing to build on this experience, taking on new challenges, and delivering innovative solutions that make a difference.`,
    buttonText: "Details",
    startDate: "Jun 2024",
    endDate: "Present",
    icon: "work",
